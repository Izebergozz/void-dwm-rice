...
# POST-INSTALATION #
xbps-install -Syu base-devel brightnessctl pipewire alsa-pipewire libjack-pipewire wireplumber pulsemixer gimp alacritty dmenu picom \
neofetch feh pywal neovim libXinerama-devel libXft-devel xsetroot lm_sensors nerd-fonts-ttf git \
